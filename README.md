...
test/                          66 tests over the three lenses
...
The only page access is `Scan page`, which reads the resource-timing list from the tab you opened
the popup on. There is no content script and nothing is ever written to a page.
